...
public class ZincOreGen implements IWorldGenerator {
	...
	private void genOre(World world, Random rnd, int x, int z) {
		...
		for (int i = 0; i < 6; i++) {
			...
			int genY = 1 + rnd.nextInt(34);
			new WorldGenMinable(MMAURegistry.ZincOre, 0, 8, Blocks.stone).generate(world, rnd, genX, genY, genZ);
