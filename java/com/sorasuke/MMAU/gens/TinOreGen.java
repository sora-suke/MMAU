...
public class TinOreGen implements IWorldGenerator {
	...
	private void genOre(World world, Random rnd, int x, int z) {
		...
		for (int i = 0; i < 15; i++) {
			...
			int genY = 1 + rnd.nextInt(69);
			new WorldGenMinable(MMAURegistry.TinOre, 0, 8, Blocks.stone).generate(world, rnd, genX, genY, genZ);
