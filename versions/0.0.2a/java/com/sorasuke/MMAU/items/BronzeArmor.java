...
public class BronzeArmor extends ItemArmor {
    ...
    public BronzeArmor(ArmorMaterial material, int type, String localname) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
        if (this.armorType == 2) {
            return "MMAU:textures/models/armor/bronze_layer_2.png";
        }
        return "MMAU:textures/models/armor/bronze_layer_1.png";
    }
